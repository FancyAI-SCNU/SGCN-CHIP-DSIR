...
def intimacy_politeness_score(pred_pair_xy, true_pair_xy, social_dist, hinge_ratio=0.25):
    ...
    if true_pair_dist_masked.size(0) > 0:
        ...
        intimacy_score_all = ((1 + hinge_ratio) * true_pair_dist_masked - pred_pair_dist_masked) / (hinge_ratio * true_pair_dist_masked)
    ...
    if true_pair_dist_masked.size(0) > 0:
        ...
        politeness_score_all = (pred_pair_dist_masked - (1 - hinge_ratio) * true_pair_dist_masked) / (hinge_ratio * true_pair_dist_masked)
